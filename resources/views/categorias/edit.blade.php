        ...
        <div class="row g-2" >
            ...
            <div class="col-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nombrec" name="nombrec" value="{{$categorias->nombrec}}" required>
                </div>
            </div>
            ...
            <div class="col-6">
                ...
                <div class="input-group">            
                    <input type="file" id="imagen" name="imagen" class="form-control" value="{{$categorias->imagen}}">
                    {{-- <span class="input-group-text">.00</span> --}}
                </div>
            </div>

            <label for="descripcion" class="form-label">Descripción</label>
           <textarea name="descripcion" id="descripcion"  rows="3" class="form-control" value="{{$categorias->descripcion}}"></textarea>
