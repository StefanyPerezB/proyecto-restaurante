...
<body>
<div class="m-4" >
    <form action="{{ route('mesas.update', $mesas->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row g-2" >
            <div class="col-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" value="{{$mesas->nombre}}" required>
                </div>
            </div>
            ...
            <div class="col-6">
                ...
                <div class="input-group">            
                    <input type="number" id="cantidad" name="cantidad" class="form-control" value="{{$mesas->cantidad}}">
                    <span class="input-group-text">
                        <span class="bi-person"></span>
                    </span>
                </div>
            ...
            <div class="col-6">
                ...
                <div class="input-group">
                  <select name="estado" id="estado" class="form-control" value="{{$mesas->estado}}">
